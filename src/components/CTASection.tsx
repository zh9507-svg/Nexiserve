  ...
  return (
    <section id="contact" className="py-32 px-6 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="glass-card rounded-[4rem] p-12 md:p-24 text-center overflow-hidden relative group border-slate-200 bg-white/50">
          <div className="absolute inset-0 bg-linear-to-br from-slate-50 to-transparent pointer-events-none" />
          
          <div className="relative z-10">
            <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-slate-100 border border-slate-200 mb-12">
            ...
            <h2 className="text-6xl md:text-[8rem] font-black text-slate-900 leading-[0.75] tracking-tighter mb-12">
              Ready to <br />
              <span className="text-gradient">Scale?</span>
            </h2>

            <p className="max-w-3xl mx-auto text-xl md:text-2xl text-slate-500 font-medium mb-20 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-20">
              {[
                ...
                <div key={item.label} className="flex flex-col items-center gap-4 group/item">
                   <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center border border-slate-200 group-hover/item:bg-slate-900 group-hover/item:text-white transition-all duration-500 shadow-sm">
                      <item.icon className="w-8 h-8" />
                   </div>
                   <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest group-hover/item:text-slate-900 transition-colors">{item.label}</span>
                </div>
              ))}
            </div>

            <button className="bg-slate-900 text-white px-12 py-8 rounded-[2rem] font-black text-2xl hover:bg-brand transition-all shadow-2xl shadow-slate-900/10 flex items-center justify-center gap-4 mx-auto group">
              Start System Audit
