...
export default function ROICalculator() {
  ...
  return (
    <section id="roi" className="py-32 px-6 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="text-center mb-24">
          <span className="text-[10px] font-black text-brand uppercase tracking-[0.4em] mb-6 block">Investment Framework</span>
          <h2 className="text-6xl md:text-[8rem] font-black text-slate-900 leading-[0.75] tracking-tighter">
            Predictable <span className="text-gradient">Yield.</span>
          </h2>
          <p className="mt-12 text-xl text-slate-500 font-medium max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          {/* Controls */}
          <div className="bento-card bg-slate-50 border-slate-200 p-12">
            <div className="flex items-center gap-4 mb-12">
              <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-brand border border-slate-200 shadow-sm">
                <Calculator className="w-6 h-6" />
              </div>
              <h3 className="text-3xl font-black text-slate-900 tracking-tight">Revenue Assumptions</h3>
            </div>
            ...
            <div className="space-y-12">
              <div>
                <div className="flex justify-between mb-4">
                  ...
                  <span className="font-display font-black text-slate-900 text-xl">{leads}</span>
                </div>
                <input 
                  type="range" 
                  min="50" 
              ...
              <div>
                <div className="flex justify-between mb-4">
                  ...
                  <span className="font-display font-black text-slate-900 text-xl">{closeRate}%</span>
                </div>
                <input 
                  type="range" 
                  min="1" 
              ...
              <div>
                <div className="flex justify-between mb-4">
                  ...
                  <span className="font-display font-black text-slate-900 text-xl">£{dealValue.toLocaleString()}</span>
                </div>
                <input 
                  type="range" 
                  min="1000" 
          ...
          {/* Results */}
          <div className="bento-card !bg-slate-900 text-white border-none p-12 flex flex-col justify-between relative overflow-hidden shadow-2xl shadow-slate-900/40">
            ...
            <div className="relative">
              ...
              <div className="text-5xl md:text-7xl lg:text-8xl font-black leading-[0.9] tracking-tighter mb-4 text-white drop-shadow-2xl break-words">
                +£{uplift.toLocaleString()}
              </div>
              <p className="text-2xl font-display font-medium text-slate-400">Additional <span className="text-white">Monthly</span> Revenue</p>
            </div>

            <div className="grid grid-cols-2 gap-8 relative mt-16 pt-16 border-t border-white/10">
              <div>
                <Clock className="w-8 h-8 mb-4 opacity-40" />
                <div className="text-3xl font-black mb-1 text-white">~40 hrs</div>
                <div className="text-[10px] font-black uppercase tracking-widest opacity-40">Admin Time Reclaimed</div>
              </div>
              <div>
                <Users className="w-8 h-8 mb-4 opacity-40" />
                <div className="text-3xl font-black mb-1 text-white">0 staff</div>
                <div className="text-[10px] font-black uppercase tracking-widest opacity-40">New Hires Required</div>
              </div>
            </div>

            <button className="mt-12 bg-white text-slate-900 w-full py-6 rounded-2xl font-black text-xl hover:bg-brand hover:text-white transition-all flex items-center justify-center gap-3 shadow-xl">
              Scale My Revenue
